        ...
        function validate() {
            ...
            _PT = document.forms["input_form"]["_PTterm"].value;//phương vị mục tiêu
            kc = document.forms["input_form"]["kcterm"].value;//khoảng cách mục tiêu
            ...
            // tính hướng dạt tổng hợp
                ...
                var h_dattonghop = Math.atan(x_dattonghop/y_dattonghop)*180/3.14;
                } else if (0 < x_dattonghop && 0 > y_dattonghop){
                    var h_dattonghop = Math.atan(-y_dattonghop/x_dattonghop)*180/3.14 + 90;
                } else if (0 > x_dattonghop && 0 > y_dattonghop){
                    var h_dattonghop = 270 - Math.atan(-y_dattonghop/-x_dattonghop)*180/3.14;
                } else if (0 > x_dattonghop && 0 < y_dattonghop){
                    var h_dattonghop = Math.atan(y_dattonghop/-x_dattonghop)*180/3.14 + 270;
                }
